...
- (VideoFeedModel *) feedModel {
  if (_feedModel == nil) {
    _feedModel = [[VideoFeedModel alloc] init];
  }
  return _feedModel;
}
...
{
  return [self.feedModel.videos count] / 2;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  // Configure the cell...
  cell.textLabel.text = [NSString stringWithFormat:@"Video%d_name", indexPath.row];
  cell.detailTextLabel.text = [NSString stringWithFormat:@"Video%d_name", indexPath.row];
  return cell;
}
